...
#ifndef RAIANETWORK_SCRIPT_STANDARD_H
#define RAIANETWORK_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_RAIANETWORK_ASSET script that carries data
    /** RAIANETWORK END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a raianetwork address
 */
...
/**
 * Generate a Raianetwork scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // RAIANETWORK_SCRIPT_STANDARD_H

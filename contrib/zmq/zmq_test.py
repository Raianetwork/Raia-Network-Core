...
"""
    ...
    Raianetwork should be started with the command line arguments:
        raianetworkd -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND RAIA issuance at " + str(pos))
				print("After RAIA: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND RAIA something at " + str(pos))
			start += pos+8
			print(astr)

...
# TestNode: A peer we use to send messages to raianetworkd, and store responses.
...
class CompactBlocksTest(RaianetworkTestFramework):
    ...
    # This test actually causes raianetworkd to (reasonably!) disconnect us, so do this last.
    ...
    # raianetworkd's choice of nonce.
    ...
    # Test that raianetworkd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for raianetworkd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # raianetworkd will not send blocktxn responses for blocks whose height is

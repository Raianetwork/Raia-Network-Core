...
#ifndef RAIANETWORK_TEST_SCRIPTNUM10_H
#define RAIANETWORK_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from RAIA Network 0.10.0, for cross-comparison.
 */
public:
...
#endif // RAIANETWORK_TEST_BIGNUM_H

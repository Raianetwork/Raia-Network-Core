...
#ifndef RAIANETWORKCOIN_ASSET_PROTOCOL_H
#define RAIANETWORKCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_RAIANETWORK_ASSET RAIAQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_RAIANETWORK_ASSET RAIAO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_RAIANETWORK_ASSET RAIAR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_RAIANETWORK_ASSET RAIAT
...
#endif //RAIANETWORKCOIN_ASSET_PROTOCOL_H

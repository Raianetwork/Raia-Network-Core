...
#ifndef RAIANETWORK_QT_OPTIONSMODEL_H
#define RAIANETWORK_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for raianetwork client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // RaianetworkUnits::Unit
...
#endif // RAIANETWORK_QT_OPTIONSMODEL_H

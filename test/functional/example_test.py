...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the RaianetworkTestFramework
    pass

class ExampleTest(RaianetworkTestFramework):
    # Each functional test is a subclass of the RaianetworkTestFramework class.
    ...
    def custom_method(self):
        ...
        RaianetworkTestFramework class so other tests can use it."""

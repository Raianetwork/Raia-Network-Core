...
class TestRaianetworkCli(RaianetworkTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `raianetwork-cli getinfo`")
        ...
        self.log.info("Compare responses from `raianetwork-cli -getinfo` and the RPCs data is retrieved from.")

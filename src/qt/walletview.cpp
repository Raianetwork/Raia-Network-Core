...
void WalletView::setRaianetworkGUI(RaianetworkGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? RaianetworkGUI::HD44_ENABLED : _walletModel->hdEnabled() ? RaianetworkGUI::HD_ENABLED : RaianetworkGUI::HD_DISABLED);

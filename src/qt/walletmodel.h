...
#ifndef RAIANETWORK_QT_WALLETMODEL_H
#define RAIANETWORK_QT_WALLETMODEL_H
...
/** Interface to raianetwork wallet from Qt view code. */
...
#endif // RAIANETWORK_QT_WALLETMODEL_H

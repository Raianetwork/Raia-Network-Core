...
#ifndef RAIANETWORK_QT_SENDASSETSENTRY_H
#define RAIANETWORK_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending raianetwork.
...
#endif // RAIANETWORK_QT_SENDASSETSENTRY_H

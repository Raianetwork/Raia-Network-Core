...
#include "config/raianetwork-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatRaianetworkURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + RaianetworkUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatRaianetworkURI(info));
}

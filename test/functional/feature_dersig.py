...
class BIP66Test(RaianetworkTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # raianetworkd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and raianetworkd produces more specific reject
            # reasons.

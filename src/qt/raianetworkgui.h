...
#ifndef RAIANETWORK_QT_RaianetworkGUI_H
#define RAIANETWORK_QT_RaianetworkGUI_H
...
/**
  raianetwork GUI main class. This class represents the main window of the raianetwork UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class RaianetworkGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit RaianetworkGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~RaianetworkGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a raianetwork wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // RAIANETWORK_QT_RaianetworkGUI_H

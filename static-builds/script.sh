...
rm -rf ~/raianetworkcoin ~/sign ~/release
...
find ${DISTNAME}/bin -type f -executable -exec ../raianetworkcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../raianetworkcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/raianetworkcoin/temp
cd ~/raianetworkcoin/temp
tar xf ../$SOURCEDIST
...
mkdir -p ~/raianetworkcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/raianetworkcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz

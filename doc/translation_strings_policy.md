...
This document provides guidelines for internationalization of the RAIA Network software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `raianetwork_en.ts` remains unchanged.

...
class AssetTest(RaianetworkTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("RAIANETWORK1", 1000)
        n0.issue("RAIANETWORK2", 1000)
        n0.issue("RAIANETWORK3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="RAIANETWORK*", verbose=False, count=2, start=-2)
        ...
        raianetwork_assets = n0.listassets(asset="RAIANETWORK*", verbose=False, count=2, start=-2)
        assert_equal(len(raianetwork_assets), 2)
        assert_equal(raianetwork_assets[0], "RAIANETWORK2")
        assert_equal(raianetwork_assets[1], "RAIANETWORK3")
        self.sync_all()

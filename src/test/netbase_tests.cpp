...
BOOST_FIXTURE_TEST_SUITE(netbase_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(netbase_splithost_test)
    {
        ...
        BOOST_CHECK(TestSplitHost("www.raianetworkcoin.net", "www.raianetworkcoin.net", -1));
        BOOST_CHECK(TestSplitHost("[www.raianetworkcoin.net]", "www.raianetworkcoin.net", -1));
        BOOST_CHECK(TestSplitHost("www.raianetworkcoin.net:80", "www.raianetworkcoin.net", 80));
        BOOST_CHECK(TestSplitHost("[www.raianetworkcoin.net]:80", "www.raianetworkcoin.net", 80));

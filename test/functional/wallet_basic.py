...
class WalletTest(RaianetworkTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 RAIA from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 RAIA with subtract fee from amount
        ...
        # Sendmany 10 RAIA with subtract fee from amount

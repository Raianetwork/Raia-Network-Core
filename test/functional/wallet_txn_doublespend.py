...
class TxnMallTest(RaianetworkTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 RAIA:
        ...
        # First: use raw transaction API to send 1240 RAIA to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 RAIA coin each
        ...
        # Node0's balance should be starting balance, plus 50RAIA for another
        ...
        # Node0's total balance should be starting balance, plus 100RAIA for 

...
#ifndef RAIANETWORK_CHAINPARAMS_H
#define RAIANETWORK_CHAINPARAMS_H
 ...
 * Raianetwork system. There are three: the main network on which people trade goods
...
#endif // RAIANETWORK_CHAINPARAMS_H

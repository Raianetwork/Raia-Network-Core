...
#ifndef RAIANETWORK_VALIDATION_H
#define RAIANETWORK_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for raianetwork, with 1 minutes block intervals?
...
#endif // RAIANETWORK_VALIDATION_H

...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(RaianetworkUnits::RAIA),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->raianetworkBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->raianetworkBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(RaianetworkUnits::formatWithUnit(unit, balance, false, RaianetworkUnits::separatorAlways));
    ui->labelUnconfirmed->setText(RaianetworkUnits::formatWithUnit(unit, unconfirmedBalance, false, RaianetworkUnits::separatorAlways));
    ui->labelImmature->setText(RaianetworkUnits::formatWithUnit(unit, immatureBalance, false, RaianetworkUnits::separatorAlways));
    ui->labelTotal->setText(RaianetworkUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, RaianetworkUnits::separatorAlways));
    ui->labelWatchAvailable->setText(RaianetworkUnits::formatWithUnit(unit, watchOnlyBalance, false, RaianetworkUnits::separatorAlways));
    ui->labelWatchPending->setText(RaianetworkUnits::formatWithUnit(unit, watchUnconfBalance, false, RaianetworkUnits::separatorAlways));
    ui->labelWatchImmature->setText(RaianetworkUnits::formatWithUnit(unit, watchImmatureBalance, false, RaianetworkUnits::separatorAlways));
    ui->labelWatchTotal->setText(RaianetworkUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, RaianetworkUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("RAIA")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the RAIA balance grid from expanding and looking terrible when asset balance is hidden

...
#ifndef RAIANETWORK_QT_RESTRICTEDASSETSDIALOG_H
#define RAIANETWORK_QT_RESTRICTEDASSETSDIALOG_H
...
/** Dialog for sending raianetwork */
...
#endif // RAIANETWORK_QT_RESTRICTEDASSETSSDIALOG_H

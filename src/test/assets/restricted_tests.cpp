...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler raia tx
        CScript raiaTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut raiaOut(1*COIN, raiaTransfer);
        ...
        mutTxTest1.vout.emplace_back(raiaOut); 
        ...
        mutTxTest2.vout.emplace_back(raiaOut);
        ...
        mutTxTest3.vout.emplace_back(raiaOut);
        ...
        mutTxTest4.vout.emplace_back(raiaOut);
        ...
        mutTxTest5.vout.emplace_back(raiaOut);
        ...
        mutTxTest6.vout.emplace_back(raiaOut);
        ...
        mutTxTest7.vout.emplace_back(raiaOut);
        ...
        mutTxTest8.vout.emplace_back(raiaOut);

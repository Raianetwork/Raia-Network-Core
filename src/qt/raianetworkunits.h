...
#ifndef RAIANETWORK_QT_RAIANETWORKUNITS_H
#define RAIANETWORK_QT_RAIANETWORKUNITS_H
...
/** raianetwork unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RaianetworkUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RaianetworkUnits(QObject *parent);
...
typedef RaianetworkUnits::Unit RaianetworkUnit;

#endif // RAIANETWORK_QT_RAIANETWORKUNITS_H

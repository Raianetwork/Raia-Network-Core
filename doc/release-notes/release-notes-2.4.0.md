RAIA Network version *2.4.0* is now available!!
==============
...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/Raianetwork/Raia-Network-core/issues>

To receive security and update notifications, please subscribe to:

  <https://raianetwork.xyz/en/list/announcements/join/>
...
installer (on Windows) or just copy over `/Applications/Raianetwork-Qt` (on Mac)
or `raianetworkd`/`raianetwork-qt` (on Linux).
...
RAIA Network is extensively tested on multiple operating systems using
the Linux kernel, macOS 10.8+, and Windows 10(x64) and later. 32-bit versions of Windows,
and Windows XP are not supported.

RAIA Network should also work on most other Unix-like systems but is not
frequently tested on them.

RAIA Network has been tested with macOS 10.14 Mojave, but it is recommended that *developers*
...
RAIA Network has not been tested with macOS Catalina(beta). Please use at your own risk.
...
Changelog available here: <https://github.com/Raianetwork/Raia-Network-core/commits/release_2.4.0>
...
- Most importantly - The Raianetwork Community!

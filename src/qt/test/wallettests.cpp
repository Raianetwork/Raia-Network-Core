...
#include "qt/raianetworkamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<RaianetworkAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_raianetwork-qt -platform xcb      # Linux
//     src/qt/test/test_raianetwork-qt -platform windows  # Windows
//     src/qt/test/test_raianetwork-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = RaianetworkUnits::formatWithUnit(unit, balance, false, RaianetworkUnits::separatorAlways);
    ...
    // Amount input
    RaianetworkAmountField* amountInput = receiveCoinsDialog.findChild<RaianetworkAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: raianetwork:")) != -1);

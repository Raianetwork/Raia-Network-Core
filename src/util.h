 ...
 */
#ifndef RAIANETWORK_UTIL_H
#define RAIANETWORK_UTIL_H
...
extern const char *const RAIANETWORK_CONF_FILENAME;
extern const char *const RAIANETWORK_PID_FILENAME;
...
{
    std::string s = strprintf("raianetwork-%s", name);

...
By default, raianetworkd will dump mempool on shutdown and
...
class MempoolPersistTest(RaianetworkTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give raianetworkd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent raianetworkd from writing mempool.dat to disk. Verify that `savemempool` fails")

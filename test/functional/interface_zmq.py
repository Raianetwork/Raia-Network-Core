...
import os
import struct
from test_framework.test_framework import RaianetworkTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(RaianetworkTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that raianetwork has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("raianetworkd has not been built with zmq enabled.")

...
CAmount AmountFromValue(const UniValue& value, bool p_isRAIA)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "Raianetwork server stopping";
}
...
{
    return "> raianetwork-cli " + methodname + " " + args + "\n";
}
